		         ...
		         /**    for (Comission comission : comissions) {
		    		 ...
		    		 while (iter.hasNext()){
		    			 if(iter.next().equals(comissions.get(0))){
			                 double newComission = comissions.get(0).getComission().doubleValue() * (100 + percentage)/100;
		         ...
		         /**    for (Comission comission : comissions) {
		    		 ...
		    		 while (iter.hasNext()){
		    			 if(iter.next().equals(comissions.get(1))){
			                 double newComission = comissions.get(1).getComission().doubleValue() * (100 + percentage)/100;
		...
		public void increaseComissionCreditRenovate(int percentage) {
   		 ...
   		 while (iter.hasNext()){
   			 if(iter.next().equals(comissions.get(2))){
	                 double newComission = comissions.get(2).getComission().doubleValue() * (100 + percentage)/100;
		...
		public void increaseComissionDebitEmission(int percentage) {
  		 ...
  		 while (iter.hasNext()){
  			 if(iter.next().equals(comissions.get(3))){
	                 double newComission = comissions.get(3).getComission().doubleValue() * (100 + percentage)/100;
		...
		public void increaseComissionDebitMaintenance(int percentage) {
  		 ...
  		 while (iter.hasNext()){
  			 if(iter.next().equals(comissions.get(4))){
	                 double newComission = comissions.get(4).getComission().doubleValue() * (100 + percentage)/100;
		...
		public void increaseComissionDebitRenovate(int percentage) {
  		 ...
  		 while (iter.hasNext()){
  			 if(iter.next().equals(comissions.get(5))){
	                 double newComission = comissions.get(5).getComission().doubleValue() * (100 + percentage)/100;
