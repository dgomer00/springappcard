...
public class ComissionIncreaseFormController {
    ...
    public String onSubmit(@Valid ComissionIncrease comissionIncrease, BindingResult result)
    {
        ...
        int increaseCreditEmission = comissionIncrease.getPercentageCreditEmission();
        logger.info("Increasing comission by " + increaseCreditEmission + "%.");
        comissionManager.increaseComissionCreditEmission(increaseCreditEmission);
        
        int increaseCreditMaintenance = comissionIncrease.getPercentageCreditMaintenance();
        logger.info("Increasing comission by " + increaseCreditMaintenance + "%.");
        comissionManager.increaseComissionCreditMaintenance(increaseCreditMaintenance);
        
        int increaseCreditRenovate = comissionIncrease.getPercentageCreditRenovate();
        logger.info("Increasing comission by " + increaseCreditRenovate + "%.");
        comissionManager.increaseComissionCreditRenovate(increaseCreditRenovate);
        
        int increaseDebitEmission = comissionIncrease.getPercentageDebitEmission();
        ...
        int increaseDebitMaintenance = comissionIncrease.getPercentageDebitMaintenance();
        logger.info("Increasing comission by " + increaseDebitMaintenance + "%.");
        comissionManager.increaseComissionDebitMaintenance(increaseDebitMaintenance);
        
        int increaseDebitRenovate = comissionIncrease.getPercentageDebitRenovate();
