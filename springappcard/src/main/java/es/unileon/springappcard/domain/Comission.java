...
public class Comission implements Serializable {
	...
	//añadimos las anotaciones de JPA que realizan el mapeo entre los campos del objeto
	//y aquellos de la base de datos.
	//Asimismo, hemos añadido el campo id para mapear la clave primaria de la tabla comissions.
	@Id
	@Column(name = "id")
